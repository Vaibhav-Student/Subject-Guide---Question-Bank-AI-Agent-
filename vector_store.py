...
# Deferred imports to prevent hang during module loading
...
def get_embeddings():
    ...
    with _EMBEDDINGS_LOCK:
        if _EMBEDDINGS is None:
            from langchain_huggingface import HuggingFaceEmbeddings
            # sentence-transformers uses ThreadPoolExecutor internally in some versions
            # We ensure it's loaded once and shared.
...
def create_vector_store(text):
    ...
    # Step 2: Get global embeddings singleton
